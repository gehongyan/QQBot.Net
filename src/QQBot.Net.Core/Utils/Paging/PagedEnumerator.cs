...
internal class PagedAsyncEnumerable<T> : IAsyncEnumerable<IReadOnlyCollection<T>>
{
    ...
    public IAsyncEnumerator<IReadOnlyCollection<T>> GetAsyncEnumerator(CancellationToken cancellationToken = default) =>
    ...
    internal sealed class Enumerator : IAsyncEnumerator<IReadOnlyCollection<T>>
    {
        ...
        public async ValueTask<bool> MoveNextAsync()
        {
            ...
            if (_info.Remaining != 0 && _source._nextPage != null)
            {
