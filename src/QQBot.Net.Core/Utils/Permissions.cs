...
internal static class Permissions
{
    ...
    // public static ulong ResolveGuild(IGuild guild, IGuildMember user)
    // {
    ...
    /*public static ulong ResolveChannel(IGuildMember user, IGuildChannel channel)
    {
        return ResolveChannel(user, channel, ResolveGuild(user));
    }*/
    // public static ulong ResolveChannel(IGuild guild, IGuildMember user, IGuildChannel channel, ulong guildPermissions)
    // {
