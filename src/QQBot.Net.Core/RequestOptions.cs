...
{
    /// <inheritdoc cref="QQBot.RequestOptions()" />
    ...
    /// </summary>
    /// <seealso cref="QQBot.QQBotConfig.DefaultRetryMode"/>
    ...
    /// </summary>
    /// <seealso cref="QQBot.QQBotConfig.DefaultRatelimitCallback"/>
    ...
    /// </summary>
    /// <remarks>
    ///     默认的请求超时时间是 <see cref="QQBot.QQBotConfig.DefaultRequestTimeout"/>。
    /// </remarks>
    public RequestOptions()
    {
        Timeout = QQBotConfig.DefaultRequestTimeout;
