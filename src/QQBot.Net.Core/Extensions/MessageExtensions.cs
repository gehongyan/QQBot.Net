...
public static class MessageExtensions
{
    ...
    public static async Task<Cacheable<IUserMessage, string>> ReplyAsync(this IUserMessage message,
        string? content = null, IMarkdownContent? markdown = null, FileAttachment? attachment = null, Embed? embed = null, Ark? ark = null,
        MessageReference? messageReference = null, RequestOptions? options = null) =>
        await message.Channel.SendMessageAsync(content, markdown, attachment, embed, ark, messageReference, message, options).ConfigureAwait(false);
}
