...
public readonly struct Color
{
    ...
    /// <inheritdoc cref="QQBot.Color.RawValue" />
    ...
    /// <summary>
    ///     将由 QQBot.Net 定义的 <see cref="QQBot.Color"/> 颜色转换为由 .NET 定义的 <see cref="System.Drawing.Color"/> 颜色。
    /// </summary>
    /// <param name="color"> 要进行转换的 <see cref="QQBot.Color"/> 颜色。 </param>
    /// <returns> 与该 <see cref="QQBot.Color"/> 颜色具有相同色值的 .NET <see cref="System.Drawing.Color"/> 颜色。 </returns>
    public static implicit operator StandardColor(Color color) =>
        StandardColor.FromArgb((int)color.RawValue);

    /// <summary>
    ///     将由 .NET 定义的 <see cref="System.Drawing.Color"/> 颜色转换为由 QQBot.Net 定义的 <see cref="QQBot.Color"/> 颜色。
    /// </summary>
    /// <param name="color"> 要进行转换的 .NET <see cref="System.Drawing.Color"/> 颜色。 </param>
    /// <returns> 与该 .NET <see cref="System.Drawing.Color"/> 颜色具有相同色值的 <see cref="QQBot.Color"/> 颜色。 </returns>
