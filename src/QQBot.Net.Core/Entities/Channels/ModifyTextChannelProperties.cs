...
/// <summary>
///     提供用于修改 <see cref="QQBot.ITextChannel" /> 的属性。
/// </summary>
/// <seealso cref="QQBot.ITextChannel.ModifyAsync(System.Action{QQBot.ModifyTextChannelProperties},QQBot.RequestOptions)"/>
