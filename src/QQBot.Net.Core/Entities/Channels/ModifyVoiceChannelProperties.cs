...
/// <summary>
///     提供用于修改 <see cref="QQBot.IVoiceChannel" /> 的属性。
/// </summary>
/// <seealso cref="QQBot.IVoiceChannel.ModifyAsync(System.Action{QQBot.ModifyVoiceChannelProperties},QQBot.RequestOptions)"/>
