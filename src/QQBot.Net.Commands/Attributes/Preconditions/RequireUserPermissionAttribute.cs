...
//
// /// <summary>
// ///     要求调用命令的用户在命令调用所在的的子频道或频道拥有指定的权限。
// /// </summary>
...
//
//     /// <summary>
//     ///     获取或设置由于在频道的子频道外执行命令而导致的先决条件失败的错误消息。
//     /// </summary>
...
//     /// </summary>
//     /// <remarks>
//     ///     设置此先决条件将导致命令在私有子频道中无法使用。
//     /// </remarks>
//     /// <param name="permission"> 所要求调用命令的用户需要在命令调用所在的的频道拥有的权限。 </param>
...
//     ///     设置此先决条件将导致命令在私有子频道中无法使用。
//     /// </remarks>
//     /// <param name="permission"> 所要求当前用户需要在命令调用所在的的子频道拥有的权限。 </param>
