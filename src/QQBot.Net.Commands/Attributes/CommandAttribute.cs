...
public class CommandAttribute : Attribute
{
    ...
    /// </summary>
    /// <remarks>
    ///     <see cref="QQBot.Commands.NameAttribute"/> 特性重写此属性的值。
    /// </remarks>
    ...
    ///     获取或设置命令的运行模式。
    /// </summary>
    /// <seealso cref="QQBot.Commands.CommandServiceConfig.DefaultRunMode"/>
    public RunMode RunMode { get; set; } = RunMode.Default;

    /// <summary>
    ///     获取或设置是否忽略此命令的额外参数。
    /// </summary>
    /// <seealso cref="QQBot.Commands.CommandServiceConfig.IgnoreExtraArgs"/>
    ...
    /// </summary>
    /// <remarks>
    ///     <see cref="QQBot.Commands.SummaryAttribute"/> 特性重写此属性的值。
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     <see cref="QQBot.Commands.AliasAttribute"/> 特性的值会与此属性的值合并。
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     <see cref="QQBot.Commands.RemainderAttribute"/> 特性重写此属性的值。
    /// </remarks>
