namespace QQBot.Commands.Builders;
...
public class CommandBuilder
{
    ...
    ///     获取或设置此命令的优先级。
    /// </summary>
    /// <seealso cref="QQBot.Commands.PriorityAttribute(System.Int32)"/>
    ...
    internal CommandBuilder(ModuleBuilder module, string? primaryAlias,
        ...
        : this(module)
    {
        QQBot.Preconditions.NotNull(primaryAlias, nameof(primaryAlias));
        QQBot.Preconditions.NotNull(callback, nameof(callback));
