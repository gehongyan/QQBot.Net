...
/// <summary>
///     表示一个用于 <see cref="QQBot.Commands.CommandService"/> 的配置类。
/// </summary>
public class CommandServiceConfig
{
    ...
    /// </summary>
    /// <remarks>
    ///     如需在命令上重写默认行为，请使用 <see cref="QQBot.Commands.CommandAttribute.RunMode"/> 属性。
    /// </remarks>
    ...
    /// <summary>
    ///     获取或设置将引发 <see cref="QQBot.Commands.CommandService.Log"/> 事件的最低日志级别严重性。
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    ///     同步命令指的是其运行模式为 <see cref="QQBot.Commands.RunMode.Sync"/> 的命令。
    /// </remarks>
    ...
    ///     <see cref="QQBot.Commands.CommandError.BadArgCount"/>
    ///     错误。如需在命令上重写默认行为，请使用 <see cref="QQBot.Commands.CommandAttribute.IgnoreExtraArgs"/> 属性。
    /// </remarks>
