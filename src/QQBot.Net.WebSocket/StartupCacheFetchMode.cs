...
public enum StartupCacheFetchMode
{
    ...
    /// </summary>
    /// <remarks>
    ///     如果服务器数量达到了 <see cref="QQBot.WebSocket.QQBotSocketConfig.LargeNumberOfGuildsThreshold"/>
    ...
    /// </summary>
    /// <remarks>
    ///     当客户端启动时，将主动通过 QQ Bot API 获取所有服务器基础数据，数据获取完成后引发
    ...
    ///     QQ Bot API 获取所有服务器基础数据。如果在基础数据获取期间接收到与服务器相关的事件，但该服务器的基础数据尚未获取，
